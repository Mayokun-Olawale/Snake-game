//Define HTML elments we are going to need for the logic and need to manipulate in the javascript file
...
function move(){
  ...
  switch (direction){
    ...
    case 'down': 
      head.y++;
      break;
    case 'up': //Because the visual top of the screen, is y = 0. So the smaller you are, they closer you are to the top.
      head.y--;
      break;
  }
  snake.unshift(head);
  ...
  if(head.x == food.x && head.y == food.y){
      food = generateFood();
      increaseSpeed();
      clearInterval(gameInterval); //rest move function to prevent bugs
